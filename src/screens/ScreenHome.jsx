    ...
    <>
      <section className="home-hero" style={{
        ...
        <div className="home-hero-r" style={{ position:'relative', zIndex:1 }}>
          ...
          <div className="hero-card hc-3">
            <div className="hc-icon-bubble" style={{ background:'#F8E4EC' }}>
              <svg width="28" height="28" viewBox="0 0 24 24" fill="#C2185B"><path d="M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z"/></svg>
            </div>
            <div className="hc-content">
      ...
      <section className="home-quick">
        {[
          ...
          { id:'shop',   logo: logoVetrina,         title:'Vetrine',          desc:'Negozi e brand pet',      acc:'qa-shop',   onClick: () => go('shop'),   bg:'#F48FB1', fg:'#fff' },
        ].map(q => (
          <button key={q.id} className={"qa " + q.acc} onClick={q.onClick}
                  style={{ backgroundColor: q.bg, color: q.fg, borderColor: 'transparent' }}>
            <span className="qa-icn" style={{ background:'none', borderRadius:0 }}>
